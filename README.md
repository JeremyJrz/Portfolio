...
@media(max-width:768px){ header .container{flex-direction:column;gap:1rem;} header h1{font-size:1.4rem !important;} header nav ul{flex-direction:column;gap:1rem;} .hero h2{font-size:1.4rem;} } header h1{font-size:1.6rem;} header nav ul{flex-direction:column;gap:1rem;} .hero h2{font-size:1.6rem;} }
